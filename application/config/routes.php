...
$route['forgot-password']='auth/forgot_password'; $route['reset-password/(:any)']='auth/reset_password/$1';
$route['dashboard']='dashboard/index'; $route['transfers']='dashboard/transfers'; $route['cards']='dashboard/cards'; $route['cards/request']='dashboard/request_card'; $route['profile']='dashboard/profile'; $route['statement']='dashboard/statement'; $route['profile/password']='dashboard/change_password'; $route['kyc']='dashboard/kyc'; $route['loans']='dashboard/loans';
