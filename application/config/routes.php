...
$route['admin/users']='admin/users'; $route['admin/users/create']='admin/create_user'; $route['admin/users/(:num)/(:any)']='admin/update_user_status/$1/$2'; $route['admin/kyc']='admin/kyc'; $route['admin/deposits']='admin/deposits'; $route['admin/loans']='admin/loans'; $route['admin/cards']='admin/cards'; $route['admin/card-applications']='admin/card_applications'; $route['admin/managers']='admin/managers'; $route['admin/managers/create']='admin/create_manager';
