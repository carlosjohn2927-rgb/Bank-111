...
$route['dashboard']='dashboard/index'; $route['transfers']='dashboard/transfers'; $route['cards']='dashboard/cards'; $route['cards/request']='dashboard/request_card'; $route['profile']='dashboard/profile'; $route['statement']='dashboard/statement'; $route['kyc']='dashboard/kyc'; $route['loans']='dashboard/loans';
